...
(() => {
  ...
  const REGIONES_CHILE = [
    { id: 15, rom: 'XV', nom: 'Arica y Parinacota' },
    { id: 1, rom: 'I', nom: 'Tarapacá' },
    { id: 2, rom: 'II', nom: 'Antofagasta' },
    { id: 3, rom: 'III', nom: 'Atacama' },
    { id: 4, rom: 'IV', nom: 'Coquimbo' },
    { id: 5, rom: 'V', nom: 'Valparaíso' },
    { id: 6, rom: 'VI', nom: "O'Higgins" },
    { id: 7, rom: 'VII', nom: 'Maule' },
    { id: 16, rom: 'XVI', nom: 'Ñuble' },
    { id: 8, rom: 'VIII', nom: 'Biobío' },
    { id: 9, rom: 'IX', nom: 'La Araucanía' },
    { id: 14, rom: 'XIV', nom: 'Los Ríos' },
    { id: 10, rom: 'X', nom: 'Los Lagos' },
    { id: 11, rom: 'XI', nom: 'Aysén' },
    { id: 12, rom: 'XII', nom: 'Magallanes' }
  ];

  const REGION_ROM = REGIONES_CHILE.reduce((acc, r) => { acc[r.id] = r.rom; return acc; }, { 13: 'RM' });
  ...
  const CALETAS_RAW_URL = 'https://es.wikipedia.org/wiki/Anexo:Caletas_pesqueras_de_Chile?action=raw';
  ...
  const CALETAS_BY_REGION_STATIC = {
    ...
    3: ['Agua de Zorra', 'Angosta', 'Bahía Salada', 'Barranquilla', 'Caldera', 'Carrizal Bajo', 'Carrizalillo', 'Chañaral (San Pedro)', 'Chañaral de Aceituno', 'Chasco', 'El Cisne', 'El Sarco', 'Flamenco', 'Huasco', 'La Reina', 'Loreto', 'Los Bronces', 'Los Burros Sur', 'Los Pozos', 'Los Toyos', 'Maldonado', 'Obispito', 'Pajonales', 'Pan de Azúcar', 'Puerto Viejo', 'Punta Froden', 'Punta Lobos', 'Torres del Inca', 'Totoral Bajo', 'Zenteno'],
    4: ['Cascabeles', 'Chigualoco', 'Chungungo', 'Coquimbo', 'El Apolillado', 'El Sauce', 'Guanaqueros', 'Guayacán', 'Hornos', 'Huentelauquén', 'La Cebada', 'Las Conchas', 'Limarí', 'Los Choros (Choreadero)', 'Maitencillo', 'Peñuelas', 'Pichidangui', 'Playa Chica de La Herradura', 'Puerto Aldea (Hornilla)', 'Puerto Manso', 'Puerto Oscuro', 'Punta Choros A (San Agustín)', 'Punta Choros B (Los Corrales)', 'San Pedro, La Serena', 'San Pedro, Los Vilos', 'Sierra', 'Talca', 'Talcaruca', 'Talquilla', 'Tongoy', 'Totoral', 'Totoralillo Centro (Totoralillo)', 'Totoralillo Norte', 'Totoralillo Sur (Totoralillo)'],
    5: ['Alejandro Selkirk', 'Algarrobo', 'Bahía Cumberland (isla Robinson Crusoe)', 'Cartagena', 'Desembocadura Río Maipo', 'El Embarcadero', 'El Manzano', 'El Membrillo', 'El Quisco', 'Hanga Piko', 'Hanga Roa', 'Higuerilla', 'Horcón', 'Hotu Iti', 'Laguna Verde', 'Laperouse (Hanga Hoonu)', 'Las Cruces', 'Las Cujas-Cachagua', 'Ligua', 'Loncura', 'Los Molles', 'Maitencillo', 'Montemar', 'Papagallo', 'Papudo', 'Pichicuy', 'Playa Mostazal', 'Polcura', 'Portales', 'Puertecito', 'Quintay', 'San Pedro de Concón', 'San Pedro-Pacheco Altamirano', 'Sudamericana', 'Vaihu', 'Ventanas', 'Zapallar'],
    6: ['Boca de Rapel', 'Bucalemu', 'Cáhuil', 'Chorrillos', 'Matanzas', 'Pichilemu', 'Puertecillo', 'Topocalma'],
    7: ['Boyeruca', 'Cardonal', 'Constitución', 'Curanipe', 'Duao', 'Iloca', 'La Pesca', 'La Trinchera', 'Lipimávida', 'Llico', 'Loanco', 'Los Pellines', 'Maguillines', 'Pelluhue', 'Putu', 'Río Maule'],
    16: ['Boca Itata', 'Buchupureo', 'Cobquecura', 'Mela', 'Perales', 'Taucú'],
    8: ['Antiquina', 'Arauco', 'Boca Sur', 'Burca', 'Caleta Lota Bajo', 'Candelaria', 'Cantera', 'Casa de Piedra - Tirúa Sur 7', 'Cerro Verde', 'Chivilingo', 'Chome', 'Cocholgüe Caleta Chica', 'Cocholgüe Caleta Grande', 'Colcura', 'Coliumo', 'Comillahue - Tirúa Sur 6', 'Dichato', 'El Blanco', 'El Morro', 'El Soldado', 'Huentelolén', 'Infiernillo', 'Islote del Trabajo (isla Mocha)', 'La Calera (isla Mocha)', 'La Cata', 'La Conchilla', 'La Hacienda (isla Mocha)', 'Laraquete', 'Las Misiones - Tirúa Sur 1', 'Las Peñas', 'Lebu', 'Lenga', 'Lirquén', 'Llico', 'Lo Rojas', 'Locobe', 'Los Bagres', 'Los Cazones (isla Mocha)', 'Los Chilcos - Tirúa Sur 5', 'Los Piures', 'Matadero (isla Mocha)', 'Maule', 'Millonhue', 'Montecristo', 'Morguilla', 'Pangue', 'Penco', 'Peroné', 'Playa Lotilla', 'Playa Negra', 'Pueblo Hundido', 'Puente de Tierra - Tirúa Sur 2', 'Puerto Inglés', 'Puerto Norte (isla Santa María)', 'Puerto Nuevo', 'Puerto Sur (isla Santa María)', 'Punta Astorga', 'Punta Lavapié', 'Purema', 'Quiapo', 'Quichiuto', 'Quidico', 'Rocuant', 'Rumena', 'San Vicente', 'Talcahuano', 'Tirúa', 'Tomé', 'Tranaquepe', 'Tranicura A - Tirúa Sur 3', 'Tranicura B - Tirúa Sur 4', 'Tubul', 'Tumbes', 'Villarrica', 'Villarrica (Ránquil)', 'Yani'],
    9: ['Boca Budi', 'La Barra', 'Lago Budi-Nahuelhuapi', 'Los Pinos', 'Nehuentué', 'Puerto Domínguez', 'Puerto Saavedra (El Huilque)', 'Queule', 'Romopulli'],
    14: ['Amargos', 'Bahía San Juan', 'Bonifacio', 'Chaihuín', 'Chan-chan', 'Corral', 'Corral Bajo', 'El Piojo', 'Huape', 'Hueicolla', 'Huiro', 'Isla del Rey', 'La Aguada', 'La Misión', 'Lamehuapi', 'Los Molinos', 'Maiquillahue', 'Mancera', 'Mehuín', 'Mississipi', 'Niebla', 'San Carlos', 'San Ignacio', 'Tres Espinos', 'Valdivia'],
    10: ['Achao', 'Aguantao', 'Aituy', 'Alao', 'Alfaro (isla Huar)', 'Alqui (isla Tranqui)', 'Amortajado', 'Amortajado Sector A', 'Anahuac', 'Ancud', 'Angelmó', 'Añihué (grupo Chauques)', 'Apiao', 'Astillero', 'Auchac', 'Auchemó', 'Auchó', 'Aulen', 'Aulín (grupo Chauques)', 'Ayacara', 'Bahía Huelmo', 'Bahía Ilque', 'Bahía Mansa', 'Bajo Palena', 'Blandchard', 'Buill', 'Caguach', 'Caicura', 'Caipulli', 'Calbuco-La Vega', 'Caleta Gutiérrez', 'Caleta Parga', 'Caleta Poyo', 'Calle', 'Candelaria', 'Carelmapu', 'Cariquilda', 'Casa de Pesca', 'Cascajal', 'Castro', 'Catrumán', 'Caucahué', 'Caulín', 'Chacao', 'Chaicas', 'Chaicura', 'Chaiguaco', 'Chaitén', 'Chana', 'Chanhué', 'Chauchil', 'Chaulinec', 'Chauquear (isla Puluqui)', 'Chayahué', 'Chelín', 'Cheñiao (grupo Chauques)', 'Chepu', 'Chequián', 'Chinquihue', 'Cholgo', 'Cholhue (isla Huar)', 'Chonchi', 'Chope (isla Puluqui)', 'Chuit', 'Chulchuy', 'Chulín', 'Chumeldén', 'Cochamó', 'Coihuín', 'Colaco', 'Compu', 'Cóndor', 'Contao', 'Coñimó', 'Cuberos', 'Cucao', 'Curaco de Vélez', 'Curanué', 'Dalcahue', 'Duhatao', 'El Dique', 'El Estero (isla Maillen)', 'El Manzano', 'El Rosario', 'Estaquilla', 'Faro Corona', 'Fátima', 'Guabún', 'Guapilacuy', 'Hornopirén', 'Hualaihué Estero', 'Hueihue', 'Hueldén', 'Huellelhue', 'Huequi', 'Huicha', 'Huildad', 'Imerquiña/Nayahué', 'Isla Acui', 'Isla Cailín', 'Isla Chaullín', 'Isla Huapi-Abtao', 'Isla Queullín', 'Isla Tabón', 'Isla Tac', 'La Arena', 'La Pasada', 'Lamecura', 'Lechagua', 'Lenca', 'Lepihué', 'Lin Lin', 'Linao', 'Linguar', 'Liucura', 'Llanchid', 'Lleguimán', 'Lliuco', 'Lolcura', 'Los Chonos', 'Los Toros', 'Loyola', 'Machil (isla Puluqui)', 'Maicolpué', 'Manao', 'Manquemapu', 'Manzano', 'Mañihueico', 'Mapué (isla Tranqui)', 'Mar Brava', 'Maullín', 'Mechuque (grupo Chauques)', 'Metri', 'Meulín', 'Milagro', 'Muelle Toledo', 'Nal', 'Palqui', 'Panitao Bajo', 'Pargua', 'Perhue (isla Puluqui)', 'Pichicolo', 'Pichipelluco', 'Piedra Azul', 'Pilluco', 'Pollollo (isla Puluqui)', 'Pucatrihue', 'Pudeto', 'Puelche', 'Puerto Bonito (isla Llancahué)', 'Puerto Carmen', 'Puerto de Conchas (isla Llingua)', 'Puerto Hualaihué', 'Pugueñún', 'Pulelo', 'Pullihue', 'Pullinque', 'Pumalín', 'Pumillahue', 'Punta Arenas', 'Punta Capitanes', 'Punta Chilén', 'Punta Quillahua', 'Puñihuil', 'Pupelde', 'Puqueldón', 'Puqueldón (isla Maillen)', 'Quehui', 'Queilen', 'Quellón', 'Quemchi', 'Quenac', 'Quenuir', 'Quetalmahue', 'Quetén', 'Quiaca', 'Quicaví', 'Quildaco', 'Quillahua', 'Quillaipe', 'Quilo', 'Ralún', 'Rauco', 'Reldehue', 'Río Inío', 'Río Puelo Bajo', 'Rolecha', 'Rollizo', 'San Agustín', 'San Antonio (isla Quihua)', 'San Antonio de Chadmo', 'San José de Butachauques', 'San José de Tranqui (isla Tranqui)', 'San Pedro', 'San Pedro de Quellón', 'San Pedro Nolasco', 'San Rafael', 'San Ramón (isla Puluqui)', 'Santa Bárbara', 'Santa Rosa', 'Sotomó', 'Surgidero (isla Maillen)', 'Talcán', 'Taucolón (grupo Chauques)', 'Telele', 'Tenaún', 'Tenglo', 'Tentelhué', 'Teupa', 'Tril Tril', 'Voigue (grupo Chauques)', 'Yaldad', 'Yerbas Buenas', 'Yuste'],
    11: ['Caleta Andrade (isla Las Huichas)', 'Caleta Puerto Gala', 'Estero Copa (isla Las Huichas)', 'Estero Gato', 'Grupo Gala', 'Isla Costa', 'Melimoyu', 'Playas Blancas', 'Puerto Aguirre (isla Las Huichas)', 'Puerto Americano', 'Puerto Aysén', 'Puerto Chacabuco', 'Puerto Cisnes', 'Puerto Gaviota', 'Puerto Melinka', 'Puerto Puyuguapi', 'Puerto Raúl Marín Balmaceda', 'Repollal', 'Santo Domingo', 'Tortel'],
  ...
  window.onOpRegionChange = function onOpRegionChange() { window.renderOpCaletas?.(); };
  ...
  window.renderOpCaletas = async function renderOpCaletas(prefer) {
    ...
    const caletas = getCaletasForRegion(regionId, byReg);
    if (!caletas.length) {
      secEl.innerHTML = `<option value="" selected disabled>Sin caletas registradas</option><option value="${ADD_SECTOR_VALUE}">Agregar Sector...</option>`;
      secEl.value = '';
    ...
    secEl.innerHTML = opts + `<option value="${ADD_SECTOR_VALUE}">Agregar Sector...</option>`;
  ...
  function buildOpCard(op) {
    ...
    const orgName = cleanOrgName(op.org) || op.org || '';
    const titulo = `${orgName}${orgName && op.sector ? ' - ' : ''}${op.sector || ''}`.trim() || op.id;
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:13px">
      <div>
        <div style="font-family:var(--ff-d);font-size:15px;font-weight:700;color:var(--navy)">${titulo}</div>
  ...
  window.openNuevaOp = function openNuevaOp() {
    ...
    <div class="ig" id="op-add-sec-wrap" style="display:none;margin-top:8px">
      <label class="il">Agregar sector</label>
