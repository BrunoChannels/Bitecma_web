/**
 * Devuelve el SVG inline asociado a un nombre de ícono usado en la UI.
 * Se utiliza en topbar/sidebar/botones para mantener consistencia visual.
 */
export function svgIcon(name){
  const icons={
    ...
    anchor:`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C10.9 2 10 2.9 10 4C10 4.8 10.5 5.5 11.2 5.8L10 10H7L8 13H10V18C7.2 18 5 15.8 5 13H3C3 17.5 6.4 21.3 10.8 21.9L10 24H14L13.2 21.9C17.6 21.3 21 17.5 21 13H19C19 15.8 16.8 18 14 18V13H16L17 10H14L12.8 5.8C13.5 5.5 14 4.8 14 4C14 2.9 13.1 2 12 2Z"/></svg>`,
