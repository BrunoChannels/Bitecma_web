...
function especiesInner() {
  return `<div class="ph"><div><h2>Maestro de Especies</h2><p>36 especies bentónicas de Chile</p></div>
...
export default function EspeciesPage() {
  return (
    <div
      className="page"
      id="pg-especies"
      dangerouslySetInnerHTML={{ __html: especiesInner() }}
    />
  )
}
